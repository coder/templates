...
locals {
  ...
  memory-request = "1" 
  home-volume = "10Gi"
  repo = "https://github.com/coder/java_helloworld.git"
  repo-name = "java_helloworld" 
  # image = "docker.io/marktmilligan/intellij-idea-community-vnc:latest"
  image = "docker.io/codercom/enterprise-vnc:ubuntu"
}
